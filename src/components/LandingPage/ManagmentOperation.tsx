...
export default function ManagmentOperation() {
				...
				<section>
					...
					>
						...
						<span className="bg-gradient-to-r from-green-500 to-lime-500 bg-clip-text text-transparent">
							مع خاصية التنبيه الفوري بالطلبات الجديدة
						</span>
					</motion.h2>
					...
					>
						استجب بسرعة… ضاعف رضا عملاءك وزد مبيعاتك! لا تترك أي طلب يفوتك بعد
						اليوم.
					</motion.p>
					...
					<div className="mt-8 flex flex-col gap-4 sm:flex-row">
						<motion.a
							...
							href="#form"
						>
							فعّل التنبيهات الآن <Zap size={18} />
						</motion.a>
					...
					<div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
						<FeatureCard
							...
							desc="سرعة الاستجابة تعزز الثقة والولاء"
						/>
						<FeatureCard
							icon={<Globe />}
							title="رفع الكفاءة التشغيلية"
							desc="تنظيم أفضل لتدفق العمل وإدارة الموارد"
						/>
						<FeatureCard
							icon={<Zap />}
							title="ضمان عدم تفويت أي طلب"
							desc="كل طلب يوصلك فورًا، بدون تأخير"
						/>
						<FeatureCard
							icon={<Phone />}
							title="مرونة عالية"
							desc="تابع متجرك حتى وأنت خارج المكتب"
						/>
					</div>
				</section>
				...
				<aside className="relative">
					...
					>
						...
						<div className="flex items-start justify-between">
							<div>
								<div className="text-xs text-slate-500">ميزة جديدة</div>
								<h3 className="mt-1 text-xl font-semibold">
									فعّل خاصية التنبيه الفوري الآن مع شلة للتجار
								</h3>
								<p className="mt-2 text-sm text-slate-600">
									وخلّك دائمًا الأقرب لعملاءك.
								</p>
							</div>
						...
						<ul className="mt-5 space-y-3 text-sm text-slate-700">
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> استقبل
								إشعار لحظي عند أي عملية شراء
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> استجب فورًا
								وخلّ عملاءك مبسوطين
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> نظّم عملك
								بكفاءة حتى بأوقات الذروة
							</li>
						</ul>
