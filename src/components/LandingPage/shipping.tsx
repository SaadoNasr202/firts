		...
		>
			...
			<main className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-16 md:grid-cols-2">
				<section>
					...
					>
						لا تقلق بعد اليوم… نحن نوصل طلباتك بسرعة، أمان، وشفافية تبهرك وتبهر
						عملاءك.
					</motion.p>
					...
					<div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
						<FeatureCard
							icon={<Zap />}
							title="سرعة فائقة"
							desc="الشحن السريع صار الوضع الافتراضي"
						/>
						<FeatureCard
							icon={<CheckCircle />}
							title="أمان مضمون"
							desc="منتجاتك أمانة نوصلها بحالتها المثالية"
						/>
						<FeatureCard
							icon={<Globe />}
							title="شفافية كاملة"
							desc="تتبع لحظي للطلبات، لك ولعملائك"
						/>
						<FeatureCard
							icon={<Phone />}
							title="ولاء العملاء"
							desc="سمعة متجرك تتحسن"
						/>
					</div>
				</section>
				...
				<aside className="relative">
					...
					>
						...
						<div className="flex items-start justify-between">
							<div>
								<div className="text-xs text-slate-500">حلول لوجستية</div>
								<h3 className="mt-1 text-xl font-semibold">
									تواصل معنا الآن للحصول على استشارة لوجستية مجانية
								</h3>
								<p className="mt-2 text-sm text-slate-600">
									هل أنت مستعد تبهر عملاءك بأسرع توصيل جربوه؟
								</p>
							</div>
						...
						<ul className="mt-5 space-y-3 text-sm text-slate-700">
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> سرعة فائقة
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> أمان مضمون
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> شفافية
								كاملة
							</li>
						</ul>
