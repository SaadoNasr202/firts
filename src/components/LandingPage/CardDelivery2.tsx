...
export default function CardDeleviry2({
			...
			<main className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-16 md:grid-cols-2">
				<section>
					...
					>
						...
						الشريك المثالي لشركاء التوصيل في اقتصاد الخدمات عند الطلب
					</motion.h2>
					...
					>
						رسوم منخفضة + عائد طويل الأجل = أرباح أكثر واستقرار أكبر.
					</motion.p>
					...
					<div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
						<FeatureCard
							icon={<Zap />}
							title="أرباح أعلى"
							desc="عمولات أقل = دخل أكبر في كل رحلة"
						/>
						<FeatureCard
							icon={<LineChart />}
							title="استقرار ونمو"
							desc="قاعدة عملاء متزايدة توفر طلبات مستمرة"
						/>
						<FeatureCard
							icon={<Award />}
							title="برامج مكافآت"
							desc="حوافز ولاء للشركاء المميزين"
						/>
						<FeatureCard
							icon={<HeartHandshake />}
							title="شعور بالانتماء"
							desc="تُعامل كشريك ومستثمر، مش مجرد موظف"
						/>
						<FeatureCard
							icon={<Bike />}
							title="مرونة كاملة"
							desc="اختر وسيلة التوصيل المناسبة لك (دراجة، سيارة، دراجة هوائية)"
						/>
					</div>
				</section>
					...
					>
						...
						<div className="flex items-start justify-between">
							<div>
								<div className="text-xs text-slate-500">
									شريك استراتيجي في عالم التوصيل
								</div>
								<h3 className="mt-1 text-xl font-semibold">
									انضم إلى شلة اليوم وابدأ رحلتك
								</h3>
								<p className="mt-2 text-sm text-slate-600">
									ابنِ دخلاً مستدامًا واستثمر في مستقبلك.
								</p>
							</div>
						...
						<ul className="mt-5 space-y-3 text-sm text-slate-700">
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> أرباحك تكبر
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> طلباتك تزيد
							</li>
							<li className="flex items-center gap-3">
								<CheckCircle size={16} className="text-green-600" /> مستقبلك
								مضمون
							</li>
						</ul>
